...
class AccionBitacora(models.TextChoices):
    ...
    DESCARGAR = 'DESCARGAR', 'Descargar documento'
...
class Bitacora(models.Model):
    ...
    Como ahora usamos django-tenants puro, cada schema tenant tiene su propia
    tabla bitacora. Por eso ya no existe tenant_id en este modelo.
    """
