...
from .serializers import TratamientoClinicoSerializer

class TratamientoClinicoViewSet(viewsets.ModelViewSet):
    serializer_class = TratamientoClinicoSerializer
    permission_classes = [IsAuthenticated, IsMedicoOrAdmin]

    def get_queryset(self):
        return TratamientoClinico.objects.filter(id_historia_clinica=self.kwargs.get('id_historia_clinica'))
